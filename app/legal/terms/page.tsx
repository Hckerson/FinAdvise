...
export const metadata = {
  ...
  description:
    "Our terms of service outline the rules and guidelines for using our financial services and website.",
};
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
            ...
            <p>
              By accessing or using the FinAdvise Financial Services website and
            ...
            <p>
              Some parts of our Services may require you to create an account.
            ...
            <p>
              The information provided through our website, blog posts,
              newsletters, and other publicly available content is for general
              informational purposes only and should not be construed as
              financial, investment, tax, or legal advice. It is not intended to
              be a substitute for professional financial advice specific to your
              situation.
            </p>

            <h3 className="text-xl font-semibold">3.2 Client Services</h3>
            <p>
              Financial advice, planning, and investment management services are
              only provided to individuals who have entered into a written
              agreement with FinAdvise Financial Services to become clients. The
              terms of such services are governed by the specific agreements
              between FinAdvise and its clients.
            </p>
            ...
            <p>
              Past performance is not a guarantee of future results. We do not
              guarantee any specific outcome or profit from following our advice
              or using our services. All investments involve risk, including the
            ...
            <p>
              ...
              FinAdvise Financial Services and its licensors. The Services are
            ...
            <p>
              ...
              FINADVISE FINANCIAL SERVICES EXPRESSLY DISCLAIMS ALL WARRANTIES,
            ...
            <p>
              ...
              SECURE, OR ERROR-FREE, OR THAT ANY DEFECTS IN THE SERVICES WILL BE
            ...
            <p>
              IN NO EVENT SHALL FINADVISE FINANCIAL SERVICES, ITS DIRECTORS,
            ...
            <p>
              {`You agree to defend, indemnify, and hold harmless FinAdvise
                Financial Services, its affiliates, licensors, and service
            ...
            <p>
              ...
              discretion, believe violates these Terms or is harmful to other
            ...
            <p>
              ...
              these Terms at any time. The most current version will be posted
              on our website with the effective date. Your continued use of the
            ...
            <p>
              ...
              exclusive jurisdiction of the courts located in New York County,
              New York.
            </p>
            ...
            <p>
              ...
              Services will first be resolved through good-faith negotiations.
              If such negotiations fail, the dispute shall be resolved through
              binding arbitration in New York, New York, under the rules of the
              American Arbitration Association. The arbitrator's award shall be
              final and may be entered as a judgment in any court of competent
              jurisdiction.`}
            </p>
            ...
            <p>
              ...
              FinAdvise Financial Services regarding the Services and supersede
